...
export const newsItems: NewsItem[] = [
  {
    ...
    titleKk: 'BOITUMAR жаңа UL/FM сертификаттарын алды',
    titleEn: 'BOITUMAR Receives New UL/FM Certifications',
    titleRu: 'BOITUMAR получила новые сертификаты UL/FM',
    date: '2026-04-10',
    ...
    contentKk: `Біз мақтанышпен хабарлаймыз, BOITUMAR компаниясының өрт қауіпсіздігі өнімдері жаңа UL және FM сертификаттарын алды. Бұл біздің өнімдердің ең жоғары халықаралық стандарттарға сәйкестігін растайды.
...
Біз өз клиенттерімізге әрқашан жоғары сапалы және сенімді өнімдерді ұсынуға тырысамыз. UL/FM сертификаттары біздің өнімдердің өрт қауіпсіздігі жүйелеріне толық сәйкестігін кепілдік етеді.`,
    contentEn: `We are proud to announce that BOITUMAR fire safety products have received new UL and FM certifications. This confirms that our products meet the highest international standards.
...
We strive to always provide our customers with high-quality and reliable products. UL/FM certifications guarantee that our products are fully compliant with fire safety system requirements.`,
    contentRu: `Мы с гордостью сообщаем, что продукция BOITUMAR для пожарной безопасности получила новые сертификаты UL и FM. Это подтверждает соответствие наших продуктов высочайшим международным стандартам.
...
Мы стремимся всегда предоставлять нашим клиентам высококачественную и надежную продукцию. Сертификаты UL/FM гарантируют полное соответствие наших изделий требованиям систем пожарной безопасности.`,
  },
  {
    ...
    category: 'company',
    excerptKk: 'BOITUMAR жаңа өндіріс желісін іске қосты, бұл өнімділікті 40%-ға арттырады.',
    excerptEn: 'BOITUMAR has launched a new production line, increasing capacity by 40%.',
    excerptRu: 'BOITUMAR запустила новую производственную линию, увеличив мощность на 40%.',
    contentKk: `BOITUMAR компаниясы өндіріс қуатын айтарлықтай кеңейтті. Жаңа өндіріс желісі іске қосылды, бұл біздің өнімділігімізді 40%-ға арттырады.
...
Бұл инвестиция біздің клиенттерге тапсырыстарды жылдамырақ орындауға және өнімдердің ассортиментін кеңейтуге мүмкіндік береді.`,
    contentEn: `BOITUMAR has significantly expanded its production capacity. A new production line has been launched, increasing our productivity by 40%.
...
Эта инвестиция позволяет нам быстрее выполнять заказы и расширять ассортимент продукции для наших клиентов.`,
  },
  {
    ...
    contentKk: `BOITUMAR компаниясы мұнай және газ өнеркәсібіне арналған өнімдерге API (American Petroleum Institute) сертификатын алды. Бұл біздің өнімдердің жоғары сапасын және мұнай-газ саласындағы қатаң талаптарға сәйкестігін растайды.
...
API certification allows global oil and gas companies to confidently use our products.`,
    contentRu: `Компания BOITUMAR получила сертификацию API (American Petroleum Institute) для продукции, предназначенной для нефтегазовой промышленности. Это подтверждает высокое качество нашей продукции и соответствие строгим требованиям нефтегазового сектора.
...
Сертификация API позволяет мировым нефтегазовым компаниям уверенно использовать нашу продукцию.`,
  },
  {
    ...
    category: 'events',
    excerptKk: 'BOITUMAR Dubai Water Summit 2026 көрмесінде жаңа өнімдерін ұсынды.',
    excerptEn: 'BOITUMAR presented new products at Dubai Water Summit 2026.',
    excerptRu: 'BOITUMAR представила новую продукцию на выставке Dubai Water Summit 2026.',
    contentKk: `BOITUMAR компаниясы Dubai Water Summit 2026 халықаралық көрмесіне сәтті қатысты. Көрмеде біздің жаңа өнімдер желісі және инновациялық шешімдер көрсетілді.
...
Көрме кезінде біз әлемнің 45 елінен келген әріптестермен кездестік және жаңа әріптестік байланыстар орнаттық.`,
    contentEn: `BOITUMAR successfully participated in the international exhibition Dubai Water Summit 2026. The exhibition showcased our new product line and innovative solutions.
